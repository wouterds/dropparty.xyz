...
migrate: vendor
	docker exec -i internal-dropparty-website-php-fpm php ./composer.phar migrations:migrate

new-migration: vendor
	docker exec -i internal-dropparty-website-php-fpm php ./composer.phar migrations:generate
